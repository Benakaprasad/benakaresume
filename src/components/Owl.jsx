const Owl = ({ state, isDarkMode, stage, onClick, showMail = false }) => {
  ...
  {/* Branch - Normal on landing, Extended on resume */}
  {(stage === 'landing' || stage === 'resume') && state !== 'flying' && state !== 'flyingAway' && (
    <g>
      {stage === 'landing' ? (
        // Normal branch for landing page
        <>
          <path 
        ...
        // Extended branch for resume page (with baby owl)
        <>
          <path 
            d="M -30 135 Q 10 130 60 135 Q 110 140 150 132" 
            fill="none" 
            stroke="hsl(25, 50%, 28%)" 
            strokeWidth="8"
            strokeLinecap="round"
          />
          <path 
            d="M -30 135 Q 10 128 60 133 Q 110 138 150 130" 
            fill="none" 
            stroke="hsl(25, 40%, 35%)" 
            strokeWidth="4"
            strokeLinecap="round"
          ...
          <ellipse cx="130" cy="125" rx="8" ry="4" fill="hsl(140, 40%, 35%)" transform="rotate(15, 130, 125)" />
