...
const contactInfo = [
  ...
  { icon: LinkedInIcon, label: 'LinkedIn', value: 'linkedin.com/in/benakaprasadm', href: 'https://linkedin.com/in/benakaprasadm', isCustom: true },
  { icon: GitHubIcon, label: 'GitHub', value: 'github.com/Benakaprasad', href: 'https://github.com/Benakaprasad', isCustom: true },
];
        ...
        {contactInfo.map((item, idx) => (
          ...
          >
            <div className="p-3 bg-primary/10 rounded-xl group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
              {item.isCustom ? <item.icon /> : <item.icon size={24} className="text-primary group-hover:text-primary-foreground" />}
            </div>
            <div>
